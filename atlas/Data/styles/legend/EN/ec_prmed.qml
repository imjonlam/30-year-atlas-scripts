  ...
  <pipe>
    <rasterrenderer band="1" opacity="1" nodataColor="" type="paletted" alphaBand="-1">
      ...
      <colorPalette>
        ...
        <paletteEntry label="First-Year Ice" alpha="255" value="4" color="#ffff00"/>
        <paletteEntry label="Thin FIrst-Year Ice" alpha="255" value="5" color="#9bd200"/>
        <paletteEntry label="Medium First-Year Ice" alpha="255" value="6" color="#00c814"/>
        <paletteEntry label="Thick First-Year Ice" alpha="255" value="7" color="#007800"/>
        <paletteEntry label="Old Ice" alpha="255" value="8" color="#b46432"/>
