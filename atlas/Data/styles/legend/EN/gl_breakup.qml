...
<qgis minScale="1e+08" version="3.13.0-Master" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0">
  ...
  <pipe>
    <rasterrenderer band="1" opacity="1" nodataColor="" type="paletted" alphaBand="-1">
      ...
      <colorPalette>
        <paletteEntry label="No Ice - Mar 05" alpha="255" value="0" color="#96c8ff"/>
        <paletteEntry label="Mar 05" alpha="255" value="305" color="#f2f1a2"/>
        <paletteEntry label="Mar 19" alpha="255" value="319" color="#ffff00"/>
        <paletteEntry label="Apr 02" alpha="255" value="402" color="#ff0000"/>
        <paletteEntry label="Apr 16" alpha="255" value="416" color="#b007ed"/>
        <paletteEntry label="Apr 30" alpha="255" value="430" color="#071dad"/>
