  ...
  <pipe>
    <rasterrenderer band="1" opacity="1" nodataColor="" type="paletted" alphaBand="-1">
      ...
      <colorPalette>
        ...
        <paletteEntry label="Glace mince de 1    année" alpha="255" value="4" color="#9bd200"/>
        <paletteEntry label="Glace moyenne de 1    année" alpha="255" value="5" color="#00c814"/>
        <paletteEntry label="Glace épaisse de 1    année" alpha="255" value="6" color="#007800"/>
        <paletteEntry label="Vieille glace" alpha="255" value="7" color="#b46432"/>
        <paletteEntry label="Terre" alpha="255" value="8" color="#d3b58d"/>
        <paletteEntry label="Aucunes données" alpha="255" value="9" color="#ffffff"/>
      </colorPalette>
    </rasterrenderer>
